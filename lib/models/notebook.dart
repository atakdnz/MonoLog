...
class Notebook {
  ...
  @override
  String toString() {
    return 'Notebook{id: $id, title: $title, color: $color, entryStyle: $entryStyle, isPinned: $isPinned, isArchived: $isArchived, isDeleted: $isDeleted, isLocked: $isLocked, sortOrder: $sortOrder}';
  }
